(function () {
  ...
  const roleRules = {
    ...
    'Departman yöneticisi': { views: ['dashboard','leave','expenses','advances','reports','attendance','shifts','notifications','recruitment','performance','training'], create: true, approve: false },
