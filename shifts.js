  ...
  async function renderShifts(){
    ...
    document.querySelectorAll('.shift-select').forEach(select=>{select.dataset.savedValue=select.value;select.onchange=async()=>{
      ...
      try{
        ...
        localStorage.setItem(storageKey,JSON.stringify(shifts));select.dataset.savedValue=select.value;toast('Vardiya ve puantaj sunucuya kaydedildi');
